...
Copy the project and run **mvn clean install** for building the project
Use **mvn spring-boot:run** to start the server.
To Get Statistics use http://localhost:8181/statistics
To Post Transaction use http://localhost:8181/transactions

I used port:8181 in application.yml file

### Prerequisites

To run this you must have **Maven and Java 8**
